...
export class SvgMask extends Component {
    ...
    render() {
        ...
        const { dismissOnPress, stop, position, size, currentStep, isLastStep, handleNext, } = this.props;
        const onZonePress = (e) => {
            if (!(currentStep === null || currentStep === void 0 ? void 0 : currentStep.onZonePress)) {
                return;
            }
            const { locationX, locationY } = e.nativeEvent;
            if (locationX >= position.x &&
        ...
        return (React.createElement(Pressable, { style: this.props.style, onLayout: this.handleLayout, onPress: onZonePress },
