...
export class SvgMask extends Component {
    ...
    render() {
        ...
        return (React.createElement(Pressable, { style: this.props.style, onLayout: this.handleLayout, onPress: dismissOnPress ? stop : (_a = this.props.currentStep) === null || _a === void 0 ? void 0 : _a.onZonePress },
